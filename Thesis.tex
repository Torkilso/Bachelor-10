...
% New process
The process throughout the project was demanding. There have been days and even week where we felt no progress was made, causing frustration and doubt. In the initial phase of the project we spent several weeks researching how the problem could be solved, which led to many different ideas. Since many of these were complicated and difficult to work on alone, we started used development methods with a high focus on cooperation.

%old process
% TODO PROCESS ER IKKE FERDIG!
%The process from start to finish was demanding, there were days, even weeks where no progress was made. This is of course frustrating and made us doubt our ideas very often. In the initial phase of the project time went by much faster than expected, we spent several weeks just researching the most optimal way to solve the product part of our project. After the initial phase of the project we all had basic ideas about how it could be solved in the best way possible. % Nevne noen?
...
% Her kan vi legge til litt hvis det er nødvendig
% ca 1 side
