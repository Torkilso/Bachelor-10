...
The assignment was chosen for several reasons. Our curiosity for handwriting recognition was high, since solutions typically involves artificial intelligence, machine learning and advanced software engineering. These were fields we all were interested in. We had little to no prior experience with machine learning, and we knew this would be challenging. This however, made the assignment more interesting as we were motivated to learn and curious about ways to solve the problems related.

%The assignment was chosen for several reasons. Machine learning involves complex mathematics and advanced software engineering. Both mathematics and software engineering are interesting to us, thus a combination would be perfect. Curiosity was also a large part of our choice, without curiosity we would simply not have chosen this assignment in the first place. 
...
Our process during the project has been demanding. There have been days, even weeks where we felt no progress was made, causing frustration and self-doubt. In the early stages of the project we quickly understood that we needed to cooperate more than ever before to be productive. Dealing with complex subjects it was vital for us to maintain an agile mindset, we enabled that with following principles from Modern Agile.\cite{agile_modern_????}
